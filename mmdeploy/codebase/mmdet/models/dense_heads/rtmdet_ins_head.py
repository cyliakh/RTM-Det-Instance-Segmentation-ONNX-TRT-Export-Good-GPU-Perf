...
def _nms_with_mask_static(self,
    ...
    # KEEP masks at low resolution (mask_feat resolution).
    # Previous behavior upsampled with stride so masks became full-res after NMS.
    # We intentionally avoid upsampling here — boxes/labels remain identical.
