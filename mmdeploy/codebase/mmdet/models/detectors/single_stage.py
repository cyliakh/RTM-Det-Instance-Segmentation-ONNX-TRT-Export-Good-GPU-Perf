...
def single_stage_detector__forward(self,
    ...
    img_shape = torch._shape_as_tensor(batch_inputs)[2:]  # tensor of H, W
    if not is_dynamic_flag:
        # Instead of converting to Python int, keep as tensor with shape [2]
        img_shape = img_shape.to(torch.int64)  # ONNX-friendly
